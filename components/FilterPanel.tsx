...
const FilterPanel: React.FC<FilterPanelProps> = ({ onApplyFilter, isLoading }) => {
  ...
  return (
    <div className="w-full bg-slate-800/50 border border-slate-700 rounded-lg p-4 flex flex-col gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-center text-slate-300">Áp dụng Bộ lọc</h3>
      ...
      <input
        ...
        placeholder="Hoặc mô tả một bộ lọc tùy chỉnh (ví dụ: 'ánh sáng neon thập niên 80')"
